    ...
    public sealed partial class SettingsPage : Page
    {
        ...
        private void btn_PointerEntered(object sender, PointerRoutedEventArgs e)
        {
            ...
            ((Image)btnPlayEnter.Content).Source = new BitmapImage(new Uri("ms-appx:/// " +
                "Assets/Buttons/LIstOfButtons/" + ((Image)btnPlayEnter.Content).Name.Replace("img", "") + " (1).png"));
        ...
        private void btn_PointerExited(object sender, PointerRoutedEventArgs e)
        {
            ...
            ((Image)btnPlayExit.Content).Source = new BitmapImage(new Uri("ms-appx:/// " +
                "Assets/Buttons/LIstOfButtons/" + ((Image)btnPlayExit.Content).Name.Replace("img", "") + " (2).png"));
